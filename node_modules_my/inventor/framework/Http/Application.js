...
export default class Applicaiton extends IClass {
    ...
    config(configName) {
        return LogServiceProvider.load(configName)
    }
    ...
    _registerBaseServiceProvider() {
        ...
        this._session = ( new SessionServiceProvider() ).register()
    }

    _registerAppServiceProvider() {
        const providerPath = this.appPath
